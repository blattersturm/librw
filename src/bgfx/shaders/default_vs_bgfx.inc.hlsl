...
// F:\dev\code\bgfx\.build\win64_vs2019\bin\shadercRelease.exe --debug -f default.vert -o default_vs_bgfx.inc --bin2c --type v --platform windows --profile vs_4_0
...
Output main( float4 a_color0 : COLOR0 , float4 a_normal : NORMAL , float3 a_position : POSITION , float2 a_texcoord0 : TEXCOORD0) { Output _varying_; _varying_.v_color0 = float4(1.0, 0.0, 0.0, 1.0);; _varying_.v_texcoord0 = float3(0.0, 0.0, 0.0);;
{
