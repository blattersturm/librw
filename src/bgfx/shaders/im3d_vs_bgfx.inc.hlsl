...
// F:\dev\code\bgfx\.build\win64_vs2019\bin\shadercRelease.exe --debug -f im3d.vert -o im3d_vs_bgfx.inc --bin2c --type v --platform windows --profile vs_4_0
...
float4 cV = mul(u_view, V);
_varying_.gl_Position = mul(u_proj, cV);
_varying_.v_color0 = a_color0;
_varying_.v_texcoord0.xy = a_texcoord0;
_varying_.v_texcoord0.z = DoFog(_varying_.gl_Position.w);
} return _varying_;
}
